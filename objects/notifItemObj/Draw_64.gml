...
if tier >= 1 {
	draw_sprite_ext(brilloNotifSpr, -1, 444, posicionYfinal + 102, 2.5, 2.5, rotationsum, c_white, alfasprite)
	draw_sprite_ext(brilloNotifSpr, -1, 444, posicionYfinal + 102, 2.135, 2.135, rotationsum*(-1), c_white, alfasprite*0.2)
}

draw_sprite_ext(sprite, -1, 400, posicionYfinal + 58, 2.75, 2.75, 0, c_white, alfasprite)
draw_sprite_ext(sprite, -1, 400, posicionYfinal + 58, 2.75, 2.75, 0, c_white, alfasprite*0.8)